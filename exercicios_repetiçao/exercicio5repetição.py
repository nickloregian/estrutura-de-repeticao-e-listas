populaçãoA = float(input("a população da cidade A "))
populaçãoB = float(input("a população da cidade B "))
ano = 0

taxa_crescimentoA = float(input("taxa de crescimento da população da cidade A "))
taxa_crescimentoB = float(input("taxa de crescimento da população da cidade B "))
